//Трегубов Максим, лаб. №18, хэш-таблицы
#include <iostream>
#include <string>
#include <stdlib.h>
#include <ctime>
...
int main()
{
	...
	string names[10] = { "Максим","Данил","Андрей","Артем","Илья","Сергей","Иван","Михаил","Кирилл","Антон" };
	string surnames[10] = { "Новиков","Нифонтов","Мантик","Проснев","Чазов","Морозов","Кальчинко","Луговкин","Панков","Перевозников" };
	string patronymics[10] = { "Павлович","Юрьевич","Георгиевич","Максимович","Олегович","Ильич","Сергеевич","Игоревич","Александрович","Дмитреивич" };
